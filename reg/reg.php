...
<div class="row" style="max-width:1000px;height:100%; margin:auto;display:flex">
    <div  style="margin:auto;width:95vw;max-width:400px;">
		<form enctype="multipart/form-data" action="reg/testreg.php" method="post">
		  ...
		  <button type="submit" class="btn btn-primary" style="float:left">Войти</button> <a href="reg/index.php" class="btn btn-light" style="float:right">Зарегистрироваться</a>
		</form>
    </div>
